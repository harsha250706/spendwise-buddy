  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between gap-3 mb-4">
        ...
        <button
          className="w-8 h-8 rounded-lg bg-primary/10 flex items-center justify-center text-primary flex-shrink-0"
      ...
      <div className="flex gap-3 overflow-x-auto pb-2 -mx-1 px-1 scrollbar-hide">
        ...
        {groupChallenges.map((challenge) => (
          ...
          <div
            key={challenge.id}
            className="flex-shrink-0 w-44 sm:w-48 p-3 rounded-xl border border-border bg-muted/30"
          >
