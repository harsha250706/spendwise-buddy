import { Home, BarChart3, MessageCircle, Target, User } from "lucide-react";
...
const navItems = [
  ...
  { icon: MessageCircle, label: "AI Chat", path: "/chat", isCenter: true },
          ...
          if (item.isCenter) {
            return (
              ...
              >
                <motion.div
                  whileTap={{ scale: 0.9 }}
                  className={`w-14 h-14 rounded-full flex items-center justify-center shadow-float ${
                    isActive ? "bg-gradient-teal" : "bg-gradient-teal"
                  }`}
                >
